...
def run_qiskit_simulation(qc):
    # Initialize the AerSimulator with GPU support
    ...
    # Attempt to retrieve the statevector
    ...
    qc.measure_all()
    compiled_circuit_with_meas = transpile(qc, simulator)
    job_with_meas = simulator.run(compiled_circuit_with_meas, shots=10000)
    result_with_meas = job_with_meas.result()
    counts = result_with_meas.get_counts()
