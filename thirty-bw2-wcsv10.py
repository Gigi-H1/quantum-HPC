...
def run_qiskit_simulation(qc):
    ...
    transpiled_circuit_counts = transpile(qc, simulator_counts, optimization_level=0)  # Use the default or a compatible backend
    ...
    transpiled_circuit_statevector = transpile(qc_no_measure, simulator_statevector, optimization_level=0)  # Use the default or a compatible backend
