...
def run_qiskit_simulation(qc):
    ...
    return counts, result, statevector

def write_data_to_csv(counts, result, statevector, csv_file):
...
if __name__ == "__main__":
    ...
    counts, result, statevector = run_qiskit_simulation(qc)

    write_data_to_csv(counts, result, statevector, args.csv)
