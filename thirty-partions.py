...
def generate_brickwork_circuit_30_qubits():
...
qc1 = generate_brickwork_circuit_30_qubits()
qc2 = generate_brickwork_circuit_30_qubits()
...
# Run the simulations
result1 = simulator.run(compiled_circuit1, shots=10000).result()
result2 = simulator.run(compiled_circuit2, shots=10000).result()
